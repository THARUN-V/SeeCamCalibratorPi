...
class GetParams:
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--resolution",type = int, default = 0 , help = "resoultion of image to get from camera. (default : 1) \n supported resolution \n 0 : (640,480) \n 1 : (960,540) \n 2 : (1280,720) \n 3 : (1280,960) \n 4 : (1920,1080)")
        self.parser.add_argument("--res_file_name",type = str,default = "cam_calib_res.pkl",help = "file name to save calibrated result")
